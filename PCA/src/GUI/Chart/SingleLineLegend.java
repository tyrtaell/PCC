...
public class SingleLineLegend extends LegendTitle{
     ...
     */
    public SingleLineLegend(LegendItemSource source) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!PaintUtilities.equal(this.backgroundPaint, that.getBackgroundPaint())) {
            return false;
        }
        if (this.legendItemGraphicEdge != that.getLegendItemGraphicEdge()) {
            return false;
        }
        if (this.legendItemGraphicAnchor != that.getLegendItemGraphicAnchor()) {
            return false;
        }
        if (this.legendItemGraphicLocation != that.getLegendItemGraphicLocation()) {
            return false;
        }
        if (!this.itemFont.equals(that.getItemFont())) {
            return false;
        }
        if (!this.itemPaint.equals(that.getItemPaint())) {
            return false;
        }
        return true;
    }
